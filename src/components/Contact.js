            ...
            <div className='socials-container'>
              <a href={Resume} download target="_blank">
                <div className='social-item short-shadow'>
                  <div className='icon resume-icon social-icon'></div>
                  <p>Resume</p>
                </div>
              </a>
      ...
      return (
        <div className="credits-wrap">
          <div className="credits short-shadow">
            <p>
              <a target="_blank" href="https://icons8.com/icon/23883/resume">Resume</a>, <a target="_blank" href="https://icons8.com/icon/32323/instagram">Instagram</a>, <a target="_blank" href="https://icons8.com/icon/13930/linkedin">LinkedIn</a>, <a target="_blank" href="https://icons8.com/icon/63777/github">GitHub</a>, <a target="_blank" href="https://icons8.com/icon/13352/monitor">Monitor</a>, <a target="_blank" href="https://icons8.com/icon/x2kiuccLQ98j/communication-skills">Communication Skills</a>, <a target="_blank" href="https://icons8.com/icon/16368/books">Books</a> icons by <a target="_blank" href="https://icons8.com">Icons8</a>
              ...
              <p>All other art assets directly used for the creation of this website, unless otherwise stated, is by Arda Turkvan.</p>
            </p>
          </div>
        </div>
      )
