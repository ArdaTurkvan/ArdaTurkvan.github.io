...
export default {
    "projects": [
    ...
    
        {
            ...
            "year": "2023 - ???",
            "content": <div>
                <p>A 2D pixel-art dungeon-crawler roguelite creature-catching game, meant to capture the same emotions as a <a href="https://bulbapedia.bulbagarden.net/wiki/Nuzlocke_Challenge" target="__blank"><span className='important'>Pokemon Nuzlocke</span></a> playthrough. Build an ever-changing team of quirky creatures and keep them alive through strategic combat as you traverse deeper into the Drive to uncover the mysteries of the plague.</p>
